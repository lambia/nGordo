...
<body>
    ...
    <div id="divDx" class="col-xs-6">
        ...
        <div id="colorPickerFore" class="input-group colorpicker-component">
            <label for="inputFore">Foreground-Color:</label>
        ...
        <div id="colorPickerBack" class="input-group colorpicker-component">
            <label for="inputBack">Background-Color:</label>
        ...
        <row class="col-xs-6">
            <button id="btnCopyStyle" type="button" class="btn btn-secondary">Copy to</button> <!-- btn-success -->
        </row>
    </div>
</body>
</html>
